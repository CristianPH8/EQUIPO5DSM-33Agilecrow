    ...
    <div class="card-body py-5 px-md-5">
      ...
      <div class="row justify-content-center">
        <div class="col-lg-8">
          ...
          include('/wamp64/www/Pagina/startbootstrap-sb-admin-master/dist/config/controlador_editarcarrera.php');
          $sql=$conn->query("SELECT * FROM carrera WHERE id_carrera=$idcarrera ");
            ?>
           <?php
          while($datos=$sql->fetch_object()){
            ?>
            <!-- 2 column grid layout with text inputs for the first and last names -->
            <input type="hidden" name="idcarrera" value="<?= $_GET["id"] ?>">
            <div class="row">
              <div class="col-md-12 mb-4">
                <div class="form-outline">
                  <input  name="nombreca" type="text" class="form-control" value="<?= $datos->NombreC ?>" />
