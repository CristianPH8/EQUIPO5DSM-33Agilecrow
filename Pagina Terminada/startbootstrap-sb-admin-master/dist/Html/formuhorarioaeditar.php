    ...
    <div class="card-body py-5 px-md-5">
      ...
      <div class="row justify-content-center">
        <div class="col-lg-8">
          ...
          include('/wamp64/www/Pagina/startbootstrap-sb-admin-master/dist/config/controlador_editarhorarioa.php');
          $sql=$conn->query("SELECT * FROM horarioa WHERE id_horarioa=$idhorarioa");
            ?>
           <?php
          while($datos=$sql->fetch_object()){
            ...
            <input type="hidden" name="idhorarioa" value="<?= $_GET["id"] ?>">
            <div class="row justify-content-center">
            ...
            <div class="row justify-content-center">
              ...
              <!-- Mestro input -->
              <h5 class="fw-bold mb-5">Ingresa el Profesor</h5>
              <div class="row">
              <div class="col-md-12 mb-4">
                <div class="form-outline">
                <select name="Profe" class="form-control form-control-sm">  
                <?php 
                 include ('/wamp64/www/Pagina/config/conexion.php');
                 $sql=$conn->query("SELECT * FROM usuario WHERE Tipo='Profesor';"); 
                 while($datos=$sql->fetch_object()){
                   ?>  
                <option value="<?= $datos->Nombre?> <?= $datos->Ap?> <?= $datos->Am?>"><?= $datos->Nombre?> <?= $datos->Ap?> <?= $datos->Am?></option>
                <?php   }        ?>
                  </select>
