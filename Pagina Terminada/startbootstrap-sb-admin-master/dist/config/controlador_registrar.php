...
if(!empty($_POST['registro'])){
 ...
 $nombrelimpio = RemoveSpecialChar($nombre);
        ...
        function RemoveSpecialChar1($apellidop)
 {
     $res = preg_replace('/[0-9\@\!#$%&()=?¡¿{.\;\" "]+/', '', $apellidop);
     return $res;
 }
 $apellidoplimpio = RemoveSpecialChar1($apellidop);
 
        $apellidom=$_POST['apellidom'];
        function RemoveSpecialChar2($apellidom)
        {
            $res = preg_replace('/[0-9\@\!#$%&()=?¡¿{.\;\" "]+/', '', $apellidom);
            return $res;
        }
        $apellidomlimpio = RemoveSpecialChar2($apellidom);
       ...
       $sql=$conn->query(" INSERT INTO usuario VALUES('$matricula','$nombrelimpio','$apellidoplimpio','$apellidomlimpio','$telefono','$correo','$clave','$tipouser');");
